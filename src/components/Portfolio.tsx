    ...
    const projects = [
        {
            ...
            description:
                "Complete roleplay server with custom scripts, vehicles, and realistic features.",
            image:
        ...
        },
        {
            ...
            description:
                "Multiplayer adventure game with custom mechanics and monetization.",
            image:
        ...
        },
        {
            ...
            description:
                "Advanced moderation and community management bot with custom features.",
            image:
            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                        Explore some of our latest projects and see the quality of work we
                        deliver
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    {projects.map((project, index) => (
                        <Card
                            key={index}
                            className="group overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 backdrop-blur border border-white/10 bg-white/5"
                        >
                            ...
                            <CardContent className="p-6 text-white">
                                <div className="flex items-center justify-between mb-3">
                                    <Badge
                                        variant="secondary"
                                        className="bg-gradient-to-r from-purple-200 to-cyan-200 text-purple-800 border-0"
                                    >
                                        {project.category}
                                    </Badge>
                                </div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {project.tags.map((tag, tagIndex) => (
                                        <Badge
                                            key={tagIndex}
                                            variant="outline"
                                            className="text-xs border-white/20 text-gray-900"
                                        >
                                            {tag}
                                        </Badge>
                                    ))}
